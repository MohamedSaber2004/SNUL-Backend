...
namespace Sales.Services.API.Controllers
{
    ...
    public class RFQsController : AppControllerBase
    {
        ...
        [HttpGet][RoleAuthorize(UserType.Client, UserType.Admin, UserType.SnulStaff)] public async Task<IActionResult> GetAll([FromQuery] GetRFQsQuery q, CancellationToken ct) => ToActionResult(await _mediator.Send(q, ct));
        [HttpGet][Route(SalesApiRoutes.RFQs.GetById)][RoleAuthorize(UserType.Client, UserType.Admin, UserType.SnulStaff)] public async Task<IActionResult> GetById([FromRoute] Guid id, CancellationToken ct) => ToActionResult(await _mediator.Send(new GetRFQByIdQuery { Id = id }, ct));
        [HttpPost][RoleAuthorize(UserType.Client, UserType.Admin, UserType.SnulStaff)] public async Task<IActionResult> Create([FromBody] CreateRFQCommand c, CancellationToken ct) => ToActionResult(await _mediator.Send(c, ct));
    ...
    public class QuotesController : AppControllerBase
    {
        ...
        [HttpGet][RoleAuthorize(UserType.Client, UserType.Admin, UserType.SnulStaff)] public async Task<IActionResult> GetAll([FromQuery] GetQuotesQuery q, CancellationToken ct) => ToActionResult(await _mediator.Send(q, ct));
        [HttpGet][Route(SalesApiRoutes.Quotes.GetById)][RoleAuthorize(UserType.Client, UserType.Admin, UserType.SnulStaff)] public async Task<IActionResult> GetById([FromRoute] Guid id, CancellationToken ct) => ToActionResult(await _mediator.Send(new GetQuoteByIdQuery { Id = id }, ct));
        ...
        [HttpPost][Route(SalesApiRoutes.Quotes.Approve)][RoleAuthorize(UserType.Client, UserType.Admin, UserType.SnulStaff)] public async Task<IActionResult> Approve([FromRoute] Guid id, CancellationToken ct) => ToActionResult(await _mediator.Send(new ApproveQuoteCommand { Id = id }, ct));
        [HttpPost][Route(SalesApiRoutes.Quotes.Decline)][RoleAuthorize(UserType.Client, UserType.Admin, UserType.SnulStaff)] public async Task<IActionResult> Decline([FromRoute] Guid id, CancellationToken ct) => ToActionResult(await _mediator.Send(new DeclineQuoteCommand { Id = id }, ct));
    }
