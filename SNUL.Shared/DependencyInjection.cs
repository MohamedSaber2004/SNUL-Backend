...
using SNUL.Shared.Common.Repositories.Implementation.Base;
using SNUL.Shared.Common.Repositories.Interfaces.Base;
using SNUL.Shared.Common.Services;
using SNUL.Shared.Domain.Models;
using SNUL.Shared.Infrastructure.ExchangeRate;
using SNUL.Shared.Persistance;

namespace SNUL.Shared
{
    public static class DependencyInjection
    {
        public static IServiceCollection AddSnulSharedDependencies(
...
services.AddHttpClient<IWelcoIntegrationService, WelcoIntegrationService>((sp, client) =>
        ...
        public static IServiceCollection AddSnulIdentity(
            this IServiceCollection services,
            IConfiguration? configuration = null,
            Action<IdentityOptions>? configureCustomOptions = null)
        {
            ...
            services.AddIdentity<ApplicationUser, IdentityRole<Guid>>()
                .AddEntityFrameworkStores<SnulDbContext>()
